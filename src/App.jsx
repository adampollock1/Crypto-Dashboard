      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <footer className="mt-12 pt-8 border-t border-white/5">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-[#a1a7bb]">
            ...
            <p>© 2026 Portfolio Project. {isUsingMockData ? 'Demo data shown.' : 'Powered by CoinGecko API.'}</p>
            <div className="flex items-center gap-1">
              <span className={`w-2 h-2 rounded-full animate-pulse ${isUsingMockData ? 'bg-[#f7931a]' : 'bg-[#00d4aa]'}`} />
              <span>{isUsingMockData ? 'Demo Mode' : 'Live Data'}</span>
            </div>
          </div>
        </footer>
      </main>
